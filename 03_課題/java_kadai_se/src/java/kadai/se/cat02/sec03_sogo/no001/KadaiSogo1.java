...
public class KadaiSogo1 {
	public static void main(String[] args) {
		...
		//		Employee emp1 = new ExecutiveEmployee("佐藤", new BigDecimal(8000000), 20);
		...
		//		Employee emp2 = new ExecutiveEmployee("鈴木", new BigDecimal(12500000), 4);
		...
		//		Employee emp3 = new LowPaidEmployee("高橋", new BigDecimal(1280000), 3);
		...
		//		Employee emp4 = new LowPaidEmployee("田中", new BigDecimal(1570000), 8);
		...
		//		Employee emp5 = new LowPaidEmployee("伊藤", new BigDecimal(4212000), 18);
		...
		//		Employee emp6 = new PartTimePaidEmployee("渡辺", new BigDecimal(1200000), 10);
		...
		//		Employee emp7 = new PartTimePaidEmployee("山本", new BigDecimal(1500000), 9);
		...
		//		Employee emp8 = new PartTimePaidEmployee("中村", new BigDecimal(1800000), 4);
