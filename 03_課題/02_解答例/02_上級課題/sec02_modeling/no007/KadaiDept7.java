...
public class KadaiDept7 {
	...
	public static void main(String[] args) {
		...
		Row newRow = new Row(2222,"NEWありす","受付係",500, 3);
		...
		for (int i = 0; i < rows.length; i++) {
			// 「けん」という名前の人の従業員番号を表示
			System.out.println("従業員番号:" + rows[i].getEmpno() + ",名前:" + rows[i].getEname() + ",役職:" + rows[i].getJob() + ",部門番号:" + rows[i].getDeptno());
		}
		...
		System.out.println("従業員番号:" + selectRow.getEmpno() + ",名前:" + selectRow.getEname() + ",役職:" + selectRow.getJob() + ",部門番号:" + selectRow.getDeptno());
		...
		for(int i = 0; i < allRows.length; i++){
			System.out.println("従業員番号:" + allRows[i].getEmpno() + ",名前:" + allRows[i].getEname() + ",役職:" + allRows[i].getJob() + ",部門番号:" + allRows[i].getDeptno());
		}
